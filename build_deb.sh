...
# Create postinst script to install PyQt6
...
# Install PyQt6 via pip (pip should be available via dependency)
pip3 install PyQt6

echo "TRBD Event Logger installed successfully!"
echo "You can now run: trbd-event-logger"
